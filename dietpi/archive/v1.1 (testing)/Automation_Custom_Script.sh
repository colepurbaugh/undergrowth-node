...
# This script runs AFTER DietPi's first boot setup and package installation
# Handles application installation and service configuration

# Log to dietpi-automation_custom_script.log
exec &> >(tee -a /var/tmp/dietpi/logs/dietpi-automation_custom_script.log)

echo "Starting undergrowth-node post-installation setup..."

# Enable I2C interface using DietPi function
