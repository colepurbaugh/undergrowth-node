...
# Step 1: Set GPIO 12 to output mode
pigs m 12 1
# Step 2: Set PWM frequency for GPIO 12 (800Hz)
pigs pfs 12 800
# Step 3: Set PWM range (optional but recommended for better resolution)
pigs prs 12 1000
# Step 4: Set PWM duty cycle (0-range, 500 = 50% if range is 1000)
pigs p 12 500
